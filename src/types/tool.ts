...
export const TOOL_LIST: ToolConfig[] = [
  ...
  { type: 'wavyLine', label: '波浪线', icon: 'wave', shortcut: 'W', cursor: 'crosshair' },
  { type: 'redaction', label: '涂黑', icon: 'block', shortcut: 'B', cursor: 'crosshair' },
  { type: 'measureDistance', label: '距离', icon: 'ruler', shortcut: 'D', cursor: 'crosshair' },
  { type: 'measureArea', label: '面积', icon: 'area', shortcut: 'G', cursor: 'crosshair' },
  { type: 'measureAngle', label: '角度', icon: 'angle', shortcut: 'J', cursor: 'crosshair' },
